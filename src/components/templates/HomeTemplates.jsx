...
const ACCESOS_INMOBILIARIA = [
    ...
    { key: "proyectos",      icon: "solar:hard-hat-bold-duotone",          label: "Proyectos",      sub: "Obras · Remodelación · Reparación",  to: "/proyectos",      accent: "#60a5fa", glow: "rgba(96,165,250,0.35)",  big: false },
