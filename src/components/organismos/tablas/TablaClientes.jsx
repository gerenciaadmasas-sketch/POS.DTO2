...
export function TablaClientes({ data, SetopenRegistro, setdataSelect, setAccion }) {
    if (data == null) return;
    ...
    function eliminar(p) {
        confirmar({
            ...
            texto: `Se eliminará a "${p.nombre} ${p.apellido ?? ""}". ¡Esta acción no se puede deshacer!`,
            onConfirmar: () => eliminarCliente({ id: p.id }),
        });
    }
...
const Container = styled.div`
    ...
    @media (min-width: ${v.bphomer}) { margin: 2em auto; }
    ...
    .responsive-table {
        ...
        th, td {
            ...
            @media (min-width: ${v.bpbart}) { display: table-cell; padding: 0.5em; }
            @media (min-width: ${v.bphomer}) { padding: 0.75em; }
        }
        tbody {
            ...
            td {
                text-align: right;
                @media (min-width: ${v.bpbart}) { text-align: center; }
            }
