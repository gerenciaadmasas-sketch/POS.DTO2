...
export function TablaProveedores({ data, SetopenRegistro, setdataSelect, setAccion }) {
    if (data == null) return;
    const [columnFilters, setColumnFilters] = useState([]);
    const { eliminarProveedor } = useProveedoresStore();

    function eliminar(p) {
        confirmar({
            titulo: "¿Eliminar proveedor?",
            texto: `Se eliminará "${p.nombre}". ¡Esta acción no se puede deshacer!`,
            onConfirmar: () => eliminarProveedor({ id: p.id }),
        });
    }
